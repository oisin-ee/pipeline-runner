...
`moka init` installs default project skills with
`npx skills add oisincoveney/skills`, then writes generated OpenCode command
surfaces plus the singleton `pipeline-gateway` MCP entry. OpenCode is the
