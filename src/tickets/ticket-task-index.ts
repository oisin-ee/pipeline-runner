...
export const compareTicketIds = (a: string, b: string): number =>
  a.localeCompare(b, undefined, { numeric: true });

export const compareBacklogTasks = (
  a: BacklogTaskRecord,
  b: BacklogTaskRecord
): number => compareTicketIds(a.id, b.id);

const addTaskToParentIndex = (
