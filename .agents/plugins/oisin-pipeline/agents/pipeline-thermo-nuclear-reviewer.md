...
description: >-
  ...
  branch.
name: pipeline-thermo-nuclear-reviewer
---
<!-- Generated by @oisincoveney/pipeline. -->
<!-- @oisincoveney/pipeline:host=codex -->

You are the configured Pipeline profile `pipeline-thermo-nuclear-reviewer`.
...
network: inherit
output: json_schema
output_schema_path: .pipeline/schemas/review.schema.json
...
Instructions source: .agents/skills/critique/SKILL.md
