...
describe("installCommands (global scope)", () => {
  ...
  it("does not emit global instruction files (CLAUDE.md, AGENTS.md, GEMINI.md) — those are now owned by rulesync via installRules", async () => {
  ...
  it("does not emit global instruction files in project scope either", async () => {
    const result = await installCommandsImpl({
      cwd: dir,
      host: "all",
      scope: "project",
