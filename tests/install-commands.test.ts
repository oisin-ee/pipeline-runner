...
describe("installCommands", () => {
  ...
  it("installs all generated host resources from package defaults", async () => {
    ...
    expect(orchestrator).toContain("pipeline-code-writer: allow");
    const writer = readFileSync(
      join(dir, ".opencode/agents/pipeline-code-writer.md"),
      "utf8"
    );
    expect(writer).toContain("mode: subagent");
    expect(writer).toContain("hidden: false");
    expect(writer).toContain("edit: allow");
    expect(writer).toContain("lsp: allow");
    expect(writer).toContain("skill:");
    expect(writer).toContain("library-first-development: allow");
    expect(writer).toContain("task: deny");
