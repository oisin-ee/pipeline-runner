...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 routes/pipeline.ts replaced by domain modules each under ~500 lines, mounted identically (no route path changes)
- [ ] #2 DTO mappers co-located with their domain
